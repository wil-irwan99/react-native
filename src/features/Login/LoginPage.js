        ...
        <MainContainer>
            <AppBackground>   
                ...
                <View style={styles.form}>
                    <FormInput value={userName} onChangeValue={onChangeUserName} placeholder="Input Your Email" keyboard="email-address"/>
                    <FormPassword value={password} onChangeValue={onChangePassword} placeholder={"Input Your Password"}/>
                    <FormButton label="Login" onClick={() => {}}></FormButton>
                </View>
            </AppBackground>    
        </MainContainer>
    )
